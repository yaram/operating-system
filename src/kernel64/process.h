...
/*
// Positions of members in this struct are VERY IMPORTANT and relied on by assembly code
struct __attribute__((aligned(16))) GeneralStackFrame {
    ...
    // x87/MMX/SSE registers (must be 16-byte aligned, hence the padding above)
...
struct ProcessStackFrame {
    GeneralStackFrame general_frame;
